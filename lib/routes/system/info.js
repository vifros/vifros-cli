...
module.exports = {
  ...
  time  : {
    data: {
      ...
      formatter  : function (jsonapi_data) {
        var uptime = formatters.timespanInUTCtoHuman(jsonapi_data.value.up);
        var current = new Date(jsonapi_data.value.current).toString();
  ...
  os    : {
    data: {
      ...
      formatter  : function (jsonapi_data) {
        ...
        table.push({
          'Type': jsonapi_data.value.type
        }, {
          'Arch': jsonapi_data.value.arch
        }, {
          'Release': jsonapi_data.value.release
        }, {
          'Platform': jsonapi_data.value.platform
        });
  ...
  memory: {
    data: {
      ...
      formatter  : function (jsonapi_data) {
        var installed = formatters.toHumanFileSize(jsonapi_data.value.installed);
        var usage = jsonapi_data.value.usage;
