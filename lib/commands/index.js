 ...
 * @param {Array}   stack                  The last valid route path as the user typed it.
 * @param {Array}   stack_apidoc           The last valid route path but with dynamic paths marked as such by its variable names.
 *
